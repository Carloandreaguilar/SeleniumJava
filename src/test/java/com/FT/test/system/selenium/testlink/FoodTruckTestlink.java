package com.FT.test.system.selenium.testlink;
...
public class FoodTruckTestlink {
	
	

	public FoodTruckTestlink() {
	 ...
	 *            mouse al Test Case en la opcion cuando lo crean : "Especificaci�n
	 *            de Pruebas"
	 ...
	 *            mouse al Test Project en la opcion cuando lo crean : "Gesti�n del
	 *            Proyecto de Pruebas"
	 * @param paso
	 *            Indicar si paso o no
	 * @param idBuild
	 *            El Id interno del Build, se puede visualizar al acercar el mouse
	 *            al Build en la opcion cuando lo crean : "Gesti�n de Builds"
	 * @param nombreBuild
	 *            El nombre del Build
	 * @param mensaje
